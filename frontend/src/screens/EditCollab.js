...
const EditCollab = () => {
  ...
  const handleSave = () => {
    ...
    if (!cargo) {
      setCargoError('El cargo es requerido.');
      hasError = true;
    } else {
      setCargoError('');
    }
    ...
    <View style={styles.container}>
      ...
      <View style={{ marginBottom: 10, paddingHorizontal: 20 }}>
        ...
        <View style={styles.infoContainer}>
          ...
          <TextInput
            style={[styles.value, telefonoError ? styles.errorInput : {}]}
            value={telefono}
      ...
      >
        <TouchableWithoutFeedback onPress={() => setModalEspecialidadVisible(false)}>
          <View style={styles.modalBackground}>
            <View style={styles.pickerBackground}>
              <Picker
