...
const RenderForma = ({ forma, dimensiones }) => {
  // Función para renderizar las dimensiones solo si tienen valor
  const renderDimension = (label, value, position) => {
    if (value) {
      return (
        <>
    ...
    case 'Cuadrado':
      return (
        <Svg top="-5" height="120" width="120" viewBox="0 0 100 100">
          ...
          {/* Líneas representando dimensiones */}
          {renderDimension('L', dimensiones.largo, { x1: 20, y1: 11, x2: 70, y2: 11, textX: 10, textY: 75, textStyle: { top: 70, left: 130 } })}
          {renderDimension('A', dimensiones.largo, { x1: 100, y1: 40, x2: 100, y2: 90, textX: 75, textY: 19, textStyle: { top: -9, right: 20 } })}
          {renderDimension('P', dimensiones.largo, { x1: 3, y1: 68, x2: 25, y2: 90.5, textX: 105, textY: 65, textStyle: { top: 65, right: 30 } })}
    ...
    case 'Rectángulo':
      return (
        <Svg top="-5" height="140" width="180" viewBox="0 0 150 100">
          ...
          {/* Líneas representando dimensiones */}
          {renderDimension('L', dimensiones.largo, { x1: 140, y1: 50, x2: 140, y2: 91, textX: 10, textY: 75, textStyle: { top: 70, left: 180 } })}
          {renderDimension('A', dimensiones.ancho, { x1: 100, y1: 10, x2: 20, y2: 10, textX: 45, textY: 55, textStyle: { top: 10, right: 20 } })}
          {renderDimension('P', dimensiones.profundidad, { x1: 3, y1: 68, x2: 25, y2: 90.5, textX: 105, textY: 65, textStyle: { top: 65, right: 35 } })}
        </Svg>
      );
    ...
    case 'Círculo':
      return (
        <Svg height="100" width="100">
          ...
          {/* Líneas representando el diámetro */}
          {renderDimension('D', dimensiones.largo, { x1: 10, y1: 50, x2: 90, y2: 50, textX: 50, textY: 45, textStyle: { top: 41, right: 35 } })}
        </Svg>
      );
