...
const capacityTables = {
    ...
    "28.9": { 7: 14, 8: 12.8, 9: 11.8, 10: 10.9, 12: 9.5, 14: 7.8, 16: 6.1, 18: 4.8, 20: 3.9, 22: 3.1, 24: 2.5, 26: 2 },
  ...
  La función evaluateMovement recibe tres parámetros:
    ...
    - loadWeight: El peso de la carga (en toneladas).
    - boomLength: El largo de pluma (en metros).
  Evalúa si el movimiento es óptimo comparando el peso de la carga con la capacidad disponible
  según la tabla de carga correspondiente al largo de pluma.
  */
  export function evaluateMovement(radio, loadWeight, boomLength) {
    ...
    // Se determina si el movimiento es óptimo comparando el peso de la carga con la capacidad.
    const optimum = loadWeight <= capacityAvailable;
